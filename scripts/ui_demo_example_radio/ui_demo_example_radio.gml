function ui_demo_example_radio(PreviewCard) {
    PreviewCard.add(new UiText("Pick an option:", { marginBottom: 12, height: 20 }, { color: global.UI_COL_TEXT_1 }));
    ...
    return [
        "new UiText(\"Pick an option:\", { marginBottom: 12, height: 20 }, { color: global.UI_COL_TEXT_1 });",
