function ui_demo_example_tabs(PreviewCard) {
    ...
    panelA.add(new UiText("This is the content of Tab A.", { marginBottom: 8 }, { color: global.UI_COL_TEXT_2 }));
    panelA.add(new UiText("You can put any UiNode children here.", {}, { color: global.UI_COL_TEXT_2 }));
    
    var panelB = new UiNode({ flexDirection: "column" });
    panelB.add(new UiText("Tab B content goes here.", { marginBottom: 8 }, { color: global.UI_COL_TEXT_2 }));
    panelB.add(new UiButton("Action", {}, { variant: "primary" }));
    
    var panelC = new UiNode({ flexDirection: "column" });
    panelC.add(new UiText("Settings panel content.", {}, { color: global.UI_COL_TEXT_2 }));
    ...
    pillA.add(new UiText("Home panel content.", {}, { color: global.UI_COL_TEXT_2 }));
    
    var pillB = new UiNode({ flexDirection: "column" });
    pillB.add(new UiText("Profile panel content.", {}, { color: global.UI_COL_TEXT_2 }));
    
    var pillC = new UiNode({ flexDirection: "column" });
    pillC.add(new UiText("Notifications panel.", {}, { color: global.UI_COL_TEXT_2 }));
