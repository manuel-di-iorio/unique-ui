...
ui_test_suite("UiTextbox", function() {
    ...
    ui_test("placeholder stored from props", function() {
        var tb = __tb({ placeholder: "Type here..." });
    ...
    ui_test("insertText calls onChange", function() {
        ...
        var tb  = __tb({ onChange: method(state, function(v) { called_with = v; }) });
        var inp = tb.Input;
        inp.focused = true;
        inp.cursorPos = 0;
        inp.selectionStart = 0;
