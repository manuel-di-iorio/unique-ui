function ui_demo_example_typography(PreviewCard) {
    ...
    PreviewCard.add(new UiText("Heading 1", { marginBottom: 4, height: 42 }, { color: global.UI_COL_TEXT_MAIN, font: global.UI_FONTS.standard }));
    PreviewCard.add(new UiText("Heading 2", { marginBottom: 4, height: 32 }, { color: global.UI_COL_TEXT_MAIN, font: global.UI_FONTS.standard }));
    PreviewCard.add(new UiText("Heading 3", { marginBottom: 24, height: 24 }, { color: global.UI_COL_TEXT_DIM, font: global.UI_FONTS.small }));
