function ui_demo_example_typography(PreviewCard) {
    ...
    PreviewCard.add(new UiText("Big", { marginBottom: 4, height: 42 }, { color: global.UI_COL_TEXT_1, font: global.UI_FONTS.big }));
    PreviewCard.add(new UiText("Standard", { marginBottom: 4, height: 32 }, { color: global.UI_COL_TEXT_1, font: global.UI_FONTS.standard }));
    PreviewCard.add(new UiText("Small", { marginBottom: 4, height: 24 }, { color: global.UI_COL_TEXT_2, font: global.UI_FONTS.small }));
    PreviewCard.add(new UiText("Italic", { marginBottom: 24, height: 24 }, { color: global.UI_COL_TEXT_2, font: global.UI_FONTS.italic }));
