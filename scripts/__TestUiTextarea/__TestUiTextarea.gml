...
ui_test_suite("UiTextarea", function() {
    ...
    ui_test("onBlur calls parent onBlur", function() {
        var state = { value: "" };
        var ta = __ta({ value: "Done", onBlur: method(state, function(v) { value = v; }) });
