...
function ui_demo_example_toast(PreviewCard) {
    ...
    PreviewCard.add(new UiText("Toast Title (Optional):", { marginBottom: 6 }, { color: global.UI_COL_TEXT_2, font: global.UI_FONTS.small }));
    ...
    PreviewCard.add(new UiText("Toast Message:", { marginBottom: 6 }, { color: global.UI_COL_TEXT_2, font: global.UI_FONTS.small }));
    ...
    PreviewCard.add(new UiText("Duration (ms, 0 for infinite):", { marginBottom: 6 }, { color: global.UI_COL_TEXT_2, font: global.UI_FONTS.small }));
